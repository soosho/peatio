...
module Ethereum
  module OpenEth
    class Wallet < ::Ethereum::WalletAbstract
      ...
      # Override create_address! to generate address locally
      ...
      # Override create_transaction! to sign transactions locally
      ...
      # Override create_eth_transaction! to use local signing
      ...
      # Override create_erc20_transaction! to use local signing
